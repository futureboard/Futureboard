...
//!
//! Runs from a plugin crate's `build.rs` (behind the `generate` feature) to
...
impl GenerateOptions {
    ...
    /// `OUT_DIR/ui_assets`, reference `::builtin_ui_embed::EmbeddedUiAsset`
    ...
    pub fn from_out_dir(dist_dir: PathBuf, out_dir: PathBuf) -> Self {
        ...
        Self {
            ...
            assets_subdir,
            asset_type_path: "::builtin_ui_embed::EmbeddedUiAsset".to_string(),
...
fn write_source(options: &GenerateOptions, entries: &[Entry]) -> io::Result<()> {
    ...
    source.push_str("// @generated by builtin_ui_embed::generate — do not edit.\n");
